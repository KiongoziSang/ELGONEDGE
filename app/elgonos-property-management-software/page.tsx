...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "ElgonOS is property management software for Kenya with rent collection workflows, M-PESA payment routing, tenant management, Resident Community, resident services, Resident Exchange listings, leases, access control, receipts, communication, and dashboards.",
  absoluteTitle: true,
  keywords: [
    "ElgonOS",
