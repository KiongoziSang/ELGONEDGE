...
export const metadata: Metadata = createPageMetadata({
  ...
  path: "/services",
  description:
    "Explore Elgon Edge Consulting services across digital transformation, data governance, semantic layers, KPI frameworks, AI, BI, automation, cloud platforms, software engineering, training, and technology staff augmentation in Kenya.",
  absoluteTitle: true,
  keywords: [
